...
var TotalPendentes = /*#__PURE__*/function () {
  function TotalPendentes() {
    (0, _classCallCheck2["default"])(this, TotalPendentes);
  }

  (0, _createClass2["default"])(TotalPendentes, [{
    key: "index",
    value: function () {
      var _index = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(req, res) {
        var date, parsedDate, PedidosPendentes;
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                PedidosPendentes = _context.sent;
                return _context.abrupt("return", res.json(PedidosPendentes));
...
var _default = new TotalPendentes();
