...
var TotalEntregues = /*#__PURE__*/function () {
  function TotalEntregues() {
    (0, _classCallCheck2["default"])(this, TotalEntregues);
  }

  (0, _createClass2["default"])(TotalEntregues, [{
    key: "index",
    value: function () {
      var _index = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(req, res) {
        var date, parsedDate, pedidosEntregue;
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                pedidosEntregue = _context.sent;
                return _context.abrupt("return", res.json(pedidosEntregue));
  ...
  return TotalEntregues;
}();

var _default = new TotalEntregues();
